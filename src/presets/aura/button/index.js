export default {
  root: ({ props, context, parent }) => ({
    class: [
      ...
      'leading-[normal]',
      {
        'px-4 py-3': props.size === null && !props.link,
      ...
      // Link Button
      { 'text-primary-500 bg-transparent border-transparent rounded-none p-0': props.link },
      ...
      {
        '!text-secondary-700 !border-1 !border-secondary-300 !rounded-md':
