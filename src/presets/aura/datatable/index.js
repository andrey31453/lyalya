export default {
  root: ({ props }) => ({
    class: [
      'relative rounded-[24px] border border-secondary-300 overflow-hidden,',

      'max-md:p-0',
      'pl-4 pr-8 py-6',

      props.size === 'large' ? 'w-full' : 'w-fit',
  ...
  header: ({ props }) => ({
    class: [
      ...
      // Spacing
      'max-md:px-8 max-md:pt-6 rounded-[24px]',
      'pl-4',
  ...
  column: {
    headercell: ({ context, props }) => ({
      class: [
        ...
        // custom
        'text-sm text-secondary-700 font-normal',
        'p-4',
        'md:first:pl-0 last:pr-2',
        'border-0 border-b border-solid border-secondary-300',
      ],
    }),
    headercontent: {
    ...
    bodycell: ({ props, context, state, parent }) => ({
      class: [
        ...
        // custom
        'text-sm text-black font-normal align-middle',
        'md:first:pl-0 last:pr-2',
      ],
    }),
    footercell: ({ context }) => ({
  ...
  bodyrow: ({ context, props }) => ({
    class: [
      ...
      // border
      '[&:not(:last-child)]:border-b [&:not(:last-child)]:border-secondary-300',

      // State
      {
        'focus:outline-none focus:outline-offset-0 focus:bg-primary-50': context.selectable,
      },
      {
